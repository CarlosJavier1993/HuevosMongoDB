...
app = Flask(__name__)
import os
app.config["MONGO_URI"] = "mongodb+srv://myAtlasDBUser:Vpr6rUqfaZFrN5MQ@myatlasclusteredu.ngzslnw.mongodb.net/avicola?retryWrites=true&w=majority&appName=myAtlasClusterEDU"
mongo = PyMongo(app)
